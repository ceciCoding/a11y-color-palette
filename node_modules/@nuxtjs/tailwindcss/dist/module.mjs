...
import { defineNuxtModule, resolvePath, createResolver, requireModule, addTemplate, isNuxt2, installModule, addVitePlugin, addDevServerHandler } from '@nuxt/kit';
...
function vitePlugin(tailwindConfig, rootDir, cssPath) {
  ...
  return {
    ...
    handleHotUpdate(ctx) {
      if (resolvedContent.findIndex((c) => minimatch_1(ctx.file, c)) === -1) {
        return;
      }

...
var require_colorsys = __commonJS({
  "node_modules/colorsys/colorsys.js"(exports, module) {
    var RGB_MAX = 255;
    var HUE_MAX = 360;
    var SV_MAX = 100;
    ...
    colorsys.darken = function(color, percentage) {
      ...
      const transformFn = encoding === "hsl" ? (c) => c : colorsys.getTransformEncodingFunction(nextHsl, encoding);
...
// dep:colorsys
var colorsys_default = require_colorsys();
export {
  colorsys_default as default
};
//# sourceMappingURL=colorsys.js.map
